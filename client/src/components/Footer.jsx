    ...
    <footer className="relative overflow-hidden px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm/7 mt-6">
            Quick.ai is your go-to platform for cutting-edge AI tools that
            empower content creators to produce high-quality content with ease.
            Our mission is to revolutionize the way content is created by
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            <p>
              Quick AI is packed with the latest AI tools, updates, and exclusive
              offers.
            </p>
            ...
            <div className="flex items-center">
              ...
              <button className="bg-indigo-700 hover:bg-indigo-800 transition px-4 h-11 text-white rounded-r-md">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4 border-t mt-6 border-slate-200">
        <p className="text-center">
          Copyright 2025 ©
          <a href="https://quickai.com"> Quick.ai[Ujjwal]</a> All Right
          Reserved.
        </p>
