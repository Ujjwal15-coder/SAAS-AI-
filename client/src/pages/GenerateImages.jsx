...
const GenerateImages = () => {
   ...
   const imageStyle = ['Realistic','Gibhli Style','Anime Style','Cartoon Style','Fantasy Style','Realistic Style','3D Style','Portrait Style'];
  ...
  const {getToken} = useAuth()
      ...
      const onSubmitHandler = async(e) => {
        ...
        try{
          setLoading(true);
          const prompt = `Generate an image of ${input} in the style${selectedStyle} style`
